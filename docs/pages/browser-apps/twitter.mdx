...
<Steps>
    ...
    <Callout type='info'>
      Note: The Twitter Integration mimics browser-based login flow, requiring your Twitter credentials for secure interaction. Please initialize the app by providing your username and password.
    </Callout>
