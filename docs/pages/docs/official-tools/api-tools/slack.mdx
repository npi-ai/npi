...
The Slack App facilitates communication with Slack channels by providing features that allow you to send or fetch messages.

<Callout type='info'>
  Please note that the Slack App is designed as a supplementary tool for an
