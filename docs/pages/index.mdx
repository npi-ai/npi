...
as callable functions that the AI agent can invoke in response to queries. This integration allows developers to enrich
the AI's functionality by incorporating custom operations without altering the agent's core logic.

```python filename="main.py" showLineNumbers {15, 21-22}
