...
<header className="flex flex-col gap-2 items-center justify-center">
  <img src="/images/logo-full.svg" alt="NPi AI" width={300} />
  <h1 className="text-2xl font-semibold text-slate-500 text-center">Empower AI to Get Things Done for You</h1>
</header>
