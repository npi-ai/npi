...
The Google Calendar App enables you to retrieve or create events on Google Calendar.
...
<Steps>
    ...
    Follow this guide to create and download your oauth secret file: https://developers.google.com/workspace/guides/create-credentials#oauth-client-id
