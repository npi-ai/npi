...
The Twilio App facilitates communication with Twilio API by providing features that allow you to send or fetch WhatsApp or SMS messages.

<Callout type='info'>
  Please note that the Twilio App is designed as a supplementary tool for an
