...
class CreateDraftParameter(Parameter):
    ...
    message: Optional[str] = Field(default=None, description='The rich text message of the email in HTML format')
...
if __name__ == '__main__':
    gmail_agent.chat(
        'Create a draft email to dolphin.w.e+test@gmail.com stating that the email is sent from the NPi Gmail Agent. Also CC dolphin.w.e+cc@gmail.com'
    )
